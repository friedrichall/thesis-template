...
\subsection{Verwendete Sprachmodelle und Agenten}
...
Diese Daten werden von einem internen LLM-basierten Agenten verarbeitet, welcher so beispielsweise einordnen kann, ob ein Teilobjekt eher Griff, Display oder Knopf ist.
