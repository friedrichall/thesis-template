...
Aufbauend auf der in Kapitel~\ref{ch:stand_der_forschung} identifizierten Forschungslücke beschreibt dieses Kapitel die konzeptionelle Grundlage des in dieser Arbeit entwickelten Ansatzes, der im Folgenden als~\textit{Vivian Specification Generator} (VSG) bezeichnet wird. Darüber hinaus werden die zugrundeliegenden Architekturentscheidungen begründet.
...
\begin{itemize}
	...
	\item \textbf{D4:} Jede Referenz von Interaktionselementen und Visualisierungselementen in Zuständen, Übergängen, Events, Guards und Elementdefinitionen muss auf ein vorhandenes Szenenobjekt oder ein vorhandenes Element der Spezifikation verweisen.
...
Als spezialisierte Einheiten wurden ein Szenenanalyse-Agent sowie ein Agent je Spezifikationsdatei gewählt. Die Architektur dieses Ansatzes ist in Abbildung~\ref{fig:manager_approach} dargestellt.

\begin{figure}[htbp]
	\centering
	\includegraphics[width=\linewidth]{figures/vsg_modules/manager-approach.png}
	\caption{Manager-gesteuerter Multi-Agenten-Ansatz}\label{fig:manager_approach}
\end{figure}
...
\subsection{Modularer Workflow-Ansatz}\label{sec:begründung_modularer_workflow}
...
Diese modulare Trennung adressiert N1 und folgt dem in Kapitel~\ref{ch:stand_der_forschung} beschriebenen Ansatz von LLMR, welches ebenfalls einen modularen Aufbau verwendet~\cite{delatorreLLMRRealtimePrompting2024}.
