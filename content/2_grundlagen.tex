...
\section{Large Language Models und Agenten}

\subsection{Definition}

Large Language Models (LLMs) sind tiefe neuronale Netzwerke, welche die Verarbeitung von natürlicher Sprache ermöglichen und durch die Analyse riesiger Textmengen entwickelt wurden~\cite{lazerSurveyAgenticAI2026}.
...
Somit lassen sich LLMs als vortrainierte, generalisierte Modelle verstehen, welche als Grundlage für eine Vielzahl von Aufgaben dienen.
...
Die universelle Schnittstelle für solche agentischen Systeme, über die formutliert, geplant und koordiniert wird, ist die Sprache\cite{shenHuggingGPTSolvingAI2023}

\subsection{Multimodale LLMs}

\subsection{Verwendung in der vorliegenden Arbeit}

In dieser Arbeit werden LLM-basierte Agenten als Steuerungseinheiten in einer Pipeline zur Spezifikationsgeneration für das Vivian Framework verwendet.
