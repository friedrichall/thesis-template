...
Diese Reaktion verleiht der unbelebten Hülle ein\glqq Leben\grqq{}.
...
Zunächst wird das statische 3D-Modell segmentiert sowie semantisch etikettiert, was sich mit dem Begriff\glqq Labeling\grqq{} zusammenfassen lässt.
Dabei werden rohe Mesh-Geometrien in bedeutungsvolle Teile mit bestimmten Rollen zerlegt (\zB~der Griff einer Tasse oder die Sitzfläche eines Stuhls), sodass ein System später\glqq versteht\grqq{}, welches Teil eines 3D-Objekts für welche Interaktion relevant ist und eine Zuordnung stattfinden kann~\cite{moPartNetLargescaleBenchmark2018}\cite{hassaninVisualAffordanceFunction2021}.
