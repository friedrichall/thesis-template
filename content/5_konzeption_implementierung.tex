...
Listing~\ref{lst:interaction_plan_example} zeigt einen beispielhaften Ausschnitt eines vom Interaction Planner ausgegebenen Interaktionsplans.
  ...
  "element_roles": [
    {
      ...
      "rationale": "User explicitly says pushing the handle down starts toasting, and the scene confirms translational movement on the y axis with a non-zero range."
    },...
  ],...
}
\end{lstlisting}
