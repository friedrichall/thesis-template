...
Um diese Aufgaben bewältigen zu können bekommt der Consistency Reviewer einen User-Prompt bestehend aus dem kompletten Registry-Objekt (\textit{REGISTRY\_JSON}) und dem Interaktionsplan (\textit{INTERACTION\_PLAN\_JSON}) sowie einen System-Prompt, in dem Instruktionen mit den zu erfüllenden Aufgaben enthalten sind. Eine volle Version des System-Prompts ist in Anhang~\ref{sec:anhang_consistency_review_agent} zu sehen.
