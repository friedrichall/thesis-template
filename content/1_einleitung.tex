...
\begin{itemize}
    \item \textbf{F1:} Lässt sich ein Co-Creation-Workflow konzipieren und prototypisch umsetzen, in dem natürlichsprachliche Beschreibung und Korrekturschleifen die Überführung statischer 3D-Objekte in interaktive Prototypen unterstützen?
    ...
    \item \textbf{F4:} In welchem Ausmaß reduzieren Validierungs- und Selbstkorrekturmaßnahmen syntaktische, semantische und referenzielle Fehler sowie fehlgeschlagene Unity-Validierungen im Vergleich zu einem Erstgenerierungsdurchlauf ohne Korrekturschleife?
